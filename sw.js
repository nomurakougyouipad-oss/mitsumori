...
const SHELL = [
  ...
  './js/store.js?v=25',
  './js/ui.js?v=25',
  './js/screen-home.js?v=25',
  './js/screen-est.js?v=25',
  './js/screen-material.js?v=25',
  './js/catalog.js?v=25',
  './js/jis-sizes.js?v=25',
  './js/screen-order.js?v=25',
  './js/screen-settings.js?v=25',
  './js/screen-tally.js?v=25',
  './js/export.js?v=25',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

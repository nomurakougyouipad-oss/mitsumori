...
const SHELL = [
  ...
  './js/store.js?v=32',
  './js/ui.js?v=32',
  './js/screen-home.js?v=32',
  './js/screen-est.js?v=32',
  './js/screen-material.js?v=32',
  './js/catalog.js?v=32',
  './js/jis-sizes.js?v=32',
  './js/screen-order.js?v=32',
  './js/screen-settings.js?v=32',
  './js/screen-tally.js?v=32',
  './js/export.js?v=32',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

...
const SHELL = [
  ...
  './js/store.js?v=23',
  './js/ui.js?v=23',
  './js/screen-home.js?v=23',
  './js/screen-est.js?v=23',
  './js/screen-material.js?v=23',
  './js/catalog.js?v=23',
  './js/jis-sizes.js?v=23',
  './js/screen-order.js?v=23',
  './js/screen-settings.js?v=23',
  './js/screen-tally.js?v=23',
  './js/export.js?v=23',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

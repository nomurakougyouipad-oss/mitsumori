...
const SHELL = [
  ...
  './js/store.js?v=24',
  './js/ui.js?v=24',
  './js/screen-home.js?v=24',
  './js/screen-est.js?v=24',
  './js/screen-material.js?v=24',
  './js/catalog.js?v=24',
  './js/jis-sizes.js?v=24',
  './js/screen-order.js?v=24',
  './js/screen-settings.js?v=24',
  './js/screen-tally.js?v=24',
  './js/export.js?v=24',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

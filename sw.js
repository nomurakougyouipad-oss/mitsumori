...
const SHELL = [
  ...
  './js/store.js?v=30',
  './js/ui.js?v=30',
  './js/screen-home.js?v=30',
  './js/screen-est.js?v=30',
  './js/screen-material.js?v=30',
  './js/catalog.js?v=30',
  './js/jis-sizes.js?v=30',
  './js/screen-order.js?v=30',
  './js/screen-settings.js?v=30',
  './js/screen-tally.js?v=30',
  './js/export.js?v=30',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

...
const SHELL = [
  ...
  './js/store.js?v=22',
  './js/ui.js?v=22',
  './js/screen-home.js?v=22',
  './js/screen-est.js?v=22',
  './js/screen-material.js?v=22',
  './js/catalog.js?v=22',
  './js/jis-sizes.js?v=22',
  './js/screen-order.js?v=22',
  './js/screen-settings.js?v=22',
  './js/screen-tally.js?v=22',
  './js/export.js?v=22',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

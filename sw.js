...
const SHELL = [
  ...
  './js/store.js?v=29',
  './js/ui.js?v=29',
  './js/screen-home.js?v=29',
  './js/screen-est.js?v=29',
  './js/screen-material.js?v=29',
  './js/catalog.js?v=29',
  './js/jis-sizes.js?v=29',
  './js/screen-order.js?v=29',
  './js/screen-settings.js?v=29',
  './js/screen-tally.js?v=29',
  './js/export.js?v=29',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

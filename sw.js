...
const SHELL = [
  ...
  './js/store.js?v=26',
  './js/ui.js?v=26',
  './js/screen-home.js?v=26',
  './js/screen-est.js?v=26',
  './js/screen-material.js?v=26',
  './js/catalog.js?v=26',
  './js/jis-sizes.js?v=26',
  './js/screen-order.js?v=26',
  './js/screen-settings.js?v=26',
  './js/screen-tally.js?v=26',
  './js/export.js?v=26',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

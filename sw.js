...
const SHELL = [
  ...
  './js/store.js?v=31',
  './js/ui.js?v=31',
  './js/screen-home.js?v=31',
  './js/screen-est.js?v=31',
  './js/screen-material.js?v=31',
  './js/catalog.js?v=31',
  './js/jis-sizes.js?v=31',
  './js/screen-order.js?v=31',
  './js/screen-settings.js?v=31',
  './js/screen-tally.js?v=31',
  './js/export.js?v=31',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

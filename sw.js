...
const SHELL = [
  ...
  './js/store.js?v=27',
  './js/ui.js?v=27',
  './js/screen-home.js?v=27',
  './js/screen-est.js?v=27',
  './js/screen-material.js?v=27',
  './js/catalog.js?v=27',
  './js/jis-sizes.js?v=27',
  './js/screen-order.js?v=27',
  './js/screen-settings.js?v=27',
  './js/screen-tally.js?v=27',
  './js/export.js?v=27',
  './icons/icon-48.png',
  './icons/icon-120.png',
  './icons/icon-180.png',

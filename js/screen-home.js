...
import { cache, createEstimate } from './store.js?v=23';
import { openOrderWaitPage, confirmDeleteEstimate } from './screen-order.js?v=23';
import { openPendingPricePage, openReviewsPage } from './screen-settings.js?v=23';

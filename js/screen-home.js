...
import { cache, createEstimate } from './store.js?v=4';
import { openOrderWaitPage } from './screen-order.js?v=4';
import { openPendingPricePage, openReviewsPage } from './screen-settings.js?v=4';

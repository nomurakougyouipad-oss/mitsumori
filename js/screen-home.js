...
import { cache, createEstimate } from './store.js?v=9';
import { openOrderWaitPage } from './screen-order.js?v=9';
import { openPendingPricePage, openReviewsPage } from './screen-settings.js?v=9';

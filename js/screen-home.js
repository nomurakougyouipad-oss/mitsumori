...
import { cache, createEstimate } from './store.js?v=5';
import { openOrderWaitPage } from './screen-order.js?v=5';
import { openPendingPricePage, openReviewsPage } from './screen-settings.js?v=5';

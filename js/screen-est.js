...
import { esc, YEN, fmtDateJa, local } from './util.js?v=25';
import { icons } from './icons.js?v=25';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=25';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=25';
import { totals, lineAmount, excelRound } from './calc.js?v=25';
import {
...
} from './screen-material.js?v=25';
import { exportEstimateCsv } from './export.js?v=25';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=25#app=' + encodeURIComponent(JSON.stringify(payload));

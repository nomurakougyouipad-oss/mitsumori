...
import { esc, YEN, fmtDateJa, local } from './util.js?v=26';
import { icons } from './icons.js?v=26';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=26';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=26';
import { totals, lineAmount, excelRound } from './calc.js?v=26';
import {
...
} from './screen-material.js?v=26';
import { exportEstimateCsv } from './export.js?v=26';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=26#app=' + encodeURIComponent(JSON.stringify(payload));

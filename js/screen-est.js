...
import { esc, YEN, fmtDateJa, local } from './util.js?v=21';
import { icons } from './icons.js?v=21';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=21';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=21';
import { totals, lineAmount, excelRound } from './calc.js?v=21';
import {
...
} from './screen-material.js?v=21';
import { exportEstimateCsv } from './export.js?v=21';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=21#app=' + encodeURIComponent(JSON.stringify(payload));

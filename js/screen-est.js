...
import { esc, YEN, fmtDateJa, local } from './util.js?v=24';
import { icons } from './icons.js?v=24';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=24';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=24';
import { totals, lineAmount, excelRound } from './calc.js?v=24';
import {
...
} from './screen-material.js?v=24';
import { exportEstimateCsv } from './export.js?v=24';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=24#app=' + encodeURIComponent(JSON.stringify(payload));

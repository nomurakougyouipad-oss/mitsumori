...
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=27';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=27';
import { totals, lineAmount, excelRound } from './calc.js?v=27';
import {
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=27#app=' + encodeURIComponent(JSON.stringify(payload));

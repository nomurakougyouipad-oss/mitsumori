...
import { esc, YEN, fmtDateJa, local } from './util.js?v=29';
import { icons } from './icons.js?v=29';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=29';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=29';
import { totals, lineAmount, excelRound } from './calc.js?v=29';
import {
...
} from './screen-material.js?v=29';
import { exportEstimateCsv } from './export.js?v=29';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=29#app=' + encodeURIComponent(JSON.stringify(payload));

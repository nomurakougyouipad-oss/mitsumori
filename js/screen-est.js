...
import { esc, YEN, fmtDateJa, local } from './util.js?v=30';
import { icons } from './icons.js?v=30';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=30';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=30';
import { totals, lineAmount, excelRound } from './calc.js?v=30';
import {
...
} from './screen-material.js?v=30';
import { exportEstimateCsv } from './export.js?v=30';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=30#app=' + encodeURIComponent(JSON.stringify(payload));

...
import { esc, YEN, fmtDateJa, local } from './util.js?v=31';
import { icons } from './icons.js?v=31';
import { openOverlay, openNumpad, toast, confirmDialog } from './ui.js?v=31';
import {
  cache, subscribeEstimate, subscribeLines, updateEstimate,
  addLine, deleteLine, saveSummary, addNamed,
} from './store.js?v=31';
import { totals, lineAmount, excelRound } from './calc.js?v=31';
import {
...
} from './screen-material.js?v=31';
import { exportEstimateCsv } from './export.js?v=31';
...
export function openConfirmPage(estId) {
  ...
  function openHyoshi(approx) {
    ...
    const url = 'hyoshi.html?v=31#app=' + encodeURIComponent(JSON.stringify(payload));

...
import { esc, YEN, fmtDate, downloadCsv, local } from './util.js?v=20';
import { openOverlay, openNumpad, toast, confirmDialog, bindSearch, isPc, onPcChange } from './ui.js?v=20';
import {
  cache, searchItems, isStale, updateEstimate, saveSummary, addNamed,
  norm, DEFAULT_SYNONYMS, splitTerms, isTooShortTerm,
} from './store.js?v=20';
import { totals } from './calc.js?v=20';
import {
...
import { openTallyPage } from './screen-tally.js?v=20';
